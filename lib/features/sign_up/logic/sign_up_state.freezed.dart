...
class __$$UpdateLoadingImplCopyWithImpl<T, $Res>
    extends _$SignupStateCopyWithImpl<T, $Res, _$UpdateLoadingImpl<T>>
...
class _$UpdateLoadingImpl<T> implements UpdateLoading<T> {
  ...
  @override
  String toString() {
    return 'SignupState<$T>.updateLoading()';
  }
...
abstract class UpdateLoading<T> implements SignupState<T> {
...
class __$$UpdateSuccessImplCopyWithImpl<T, $Res>
    extends _$SignupStateCopyWithImpl<T, $Res, _$UpdateSuccessImpl<T>>
...
class _$UpdateSuccessImpl<T> implements UpdateSuccess<T> {
  ...
  @override
  String toString() {
    return 'SignupState<$T>.updateSuccess(data: $data)';
  }
...
abstract class UpdateSuccess<T> implements SignupState<T> {
...
class __$$UpdateErrorImplCopyWithImpl<T, $Res>
    extends _$SignupStateCopyWithImpl<T, $Res, _$UpdateErrorImpl<T>>
...
class _$UpdateErrorImpl<T> implements UpdateError<T> {
  ...
  @override
  String toString() {
    return 'SignupState<$T>.updateError(error: $error)';
  }
...
abstract class UpdateError<T> implements SignupState<T> {
